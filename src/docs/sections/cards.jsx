...
`<div class="ttam-card mod-card-2 ttam-elevation-2">
    ...
    ...
                ...
                <div className="sg-colors-code-example">
                    ...
                    <button type="button" className="reset-card-button">Reset the card</button>
                </div>
...
`<a class="ttam-card mod-card-3 ttam-elevation-3">
    ...
                ...
                <div className="sg-colors-code-example">
                    <a class="ttam-card mod-card-2 ttam-elevation-4 mod-has-gutter">
                ...
                <p>compared to</p>
                <div className="sg-colors-code-example">
                    <a class="ttam-card mod-card-2 ttam-elevation-4">

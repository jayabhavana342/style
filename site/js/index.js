(function (global, factory) {
            ...
            */
...

            {
              ...
              warning = function warning(condition, format) {
                ...
                if (!condition) {
                  ...
                  printWarning.apply(undefined$c, [format].concat(args));
                }
              };
            }
...

            {
              ...
              lowPriorityWarning = function (condition, format) {
                ...
                if (!condition) {
                  ...
                  printWarning.apply(undefined$i, [format].concat(args));
                }
              };
            }
            ...
            function hasValidRef(config$$1) {
              ...
              return config$$1.ref !== undefined$i;
            }
            ...
            function hasValidKey(config$$1) {
              ...
              return config$$1.key !== undefined$i;
            }
            ...
            function createElement(type, config$$1, children) {
              ...
              if (config$$1 != null) {
                ...
                self = config$$1.__self === undefined$i ? null : config$$1.__self;
                source = config$$1.__source === undefined$i ? null : config$$1.__source;
            ...
            function cloneElement(element, config$$1, children) {
              !!(element === null || element === undefined$i) ? invariant(false, 'React.cloneElement(...): The argument must be a React element, but you passed %s.', element) : void 0;
              ...
              if (config$$1 != null) {
                ...
                for (propName in config$$1) {
                  if (hasOwnProperty.call(config$$1, propName) && !RESERVED_PROPS.hasOwnProperty(propName)) {
                    if (config$$1[propName] === undefined$i && defaultProps !== undefined$i) {
                      // Resolve default props
                      props[propName] = defaultProps[propName];
                    } else {
                      props[propName] = config$$1[propName];
            ...
            function createContext(defaultValue, calculateChangedBits) {
              if (calculateChangedBits === undefined$i) {
            ...
            function getSourceInfoErrorAddendum(elementProps) {
              if (elementProps !== null && elementProps !== undefined$i && elementProps.__source !== undefined$i) {
            ...
            function validatePropTypes(element) {
              ...
              if (propTypes) {
                ...
                currentlyValidatingElement = null;
              } else if (type.PropTypes !== undefined$i && !propTypesMisspellWarningShown) {
            ...
            function createElementWithValidation(type, props, children) {
              ...
              if (!validType) {
                var info = '';
                if (type === undefined$i || typeof type === 'object' && type !== null && Object.keys(type).length === 0) {
            ...
            function getActiveElement(doc) /*?DOMElement*/{
              doc = doc || (typeof document !== 'undefined' ? document : undefined$n);
            ...
            c,Re);d=null;for(var f in c)if(c.hasOwnProperty(f)){var g=c[f];ra.hasOwnProperty(f)&&null!=g&&Se(e,f);}switch(b){case "input":cc(a);Mc(a,c,!0);break;case "textarea":cc(a);Ee(a,c);break;case "select":case "option":break;default:"function"===typeof c.onClick&&(a.onclick=emptyFunction_1);}return d}function Ze(a,b){return a.nodeValue!==b}
            ...
            function executeDispatch(event, simulated, listener, inst) {
              ...
              ReactErrorUtils.invokeGuardedCallbackAndCatchFirstError(type, listener, undefined$I, event);
            ...
            function getData() {
              ...
              var sliceTail = end > 1 ? 1 - end : undefined$I;
            ...
            function getValueForAttribute(node, name, expected) {
              {
                ...
                if (!node.hasAttribute(name)) {
                  return expected === undefined$I ? undefined$I : null;
                }
            ...
            function getHostProps(element, props) {
              ...
              var hostProps = _assign({}, props, {
                defaultChecked: undefined$I,
                defaultValue: undefined$I,
                value: undefined$I,
            ...
            function initWrapperState(element, props) {
              {
                ...
                if (props.checked !== undefined$I && props.defaultChecked !== undefined$I && !didWarnCheckedDefaultChecked) {
                  warning(false, '%s contains an input of type %s with both checked and defaultChecked props. ' + 'Input elements must be either controlled or uncontrolled ' + '(specify either the checked prop, or the defaultChecked prop, but not ' + 'both). Decide between using a controlled or uncontrolled input ' + 'element and remove one of these props. More info: ' + 'https://fb.me/react-controlled-components', getCurrentFiberOwnerName() || 'A component', props.type);
                  didWarnCheckedDefaultChecked = true;
                }
                if (props.value !== undefined$I && props.defaultValue !== undefined$I && !didWarnValueDefaultValue) {
            ...
            function has(key) {
              return key._reactInternalFiber !== undefined$I;
            }
            ...
            var SimpleEventPlugin = {
              ...
              isInteractiveTopLevelEventType: function (topLevelType) {
                ...
                return config$$1 !== undefined$I && config$$1.isInteractive === true;
              },
            ...
            function setOffsets(node, offsets) {
              ...
              var end = offsets.end === undefined$I ? start : Math.min(offsets.end, length);
            ...
            var localRequestAnimationFrame$1 = typeof requestAnimationFrame === 'function' ? requestAnimationFrame : undefined$I;
            ...
            function getHostProps$1(element, props) {
              var hostProps = _assign({ children: undefined$I }, props);
            ...
            function initWrapperState$1(element, props) {
              ...
              {
                if (props.value !== undefined$I && props.defaultValue !== undefined$I && !didWarnValueDefaultValue$1) {
            ...
            function postUpdateWrapper(element, props) {
              ...
              // this value down
              node._wrapperState.initialValue = undefined$I;
            ...
            function initWrapperState$2(element, props) {
              var node = element;
              {
                ...
                if (props.value !== undefined$I && props.defaultValue !== undefined$I && !didWarnValDefaultVal) {
...

            {
              ...
              validateProperty$1 = function (tagName, name, value, canUseEventSystem) {
                ...
                if (lowerCasedName === 'is' && value !== null && value !== undefined$I && typeof value !== 'string') {
            ...
            function diffProperties$1(domElement, tag, lastRawProps, nextRawProps, rootContainerElement) {
              ...
              for (propKey in nextProps) {
                var nextProp = nextProps[propKey];
                var lastProp = lastProps != null ? lastProps[propKey] : undefined$I;
                ...
                if (propKey === STYLE) {
                  ...
                  var nextHtml = nextProp ? nextProp[HTML] : undefined$I;
                  var lastHtml = lastProp ? lastProp[HTML] : undefined$I;
                  if (nextHtml != null) {
...

            {
              ...
              ReactStrictModeWarnings.recordLegacyContextWarning = function (fiber, instance) {
                ...
                if (fiber.type.contextTypes != null || fiber.type.childContextTypes != null || instance !== null && typeof instance.getChildContext === 'function') {
                  if (warningsForRoot === undefined$I) {
                    warningsForRoot = [];
                ...
                case UpdateState:
                  {
                    ...
                    if (partialState === null || partialState === undefined$I) {
            ...
            function pushProvider(providerFiber) {
...

              {
                ...
                {
                  !(context._currentRenderer === undefined$I || context._currentRenderer === null || context._currentRenderer === rendererSigil) ? warning(false, 'Detected multiple renderers concurrently rendering the ' + 'same context provider. This is currently unsupported.') : void 0;
            ...
            function applyDerivedStateFromProps(workInProgress, getDerivedStateFromProps, nextProps) {
              ...
              // Merge the partial state and the previous state.
              var memoizedState = partialState === null || partialState === undefined$I ? prevState : _assign({}, prevState, partialState);
            ...
            var classComponentUpdater = {
              ...
              enqueueSetState: function (inst, payload, callback) {
                ...
                if (callback !== undefined$I && callback !== null) {
                  {
            ...
            function checkShouldComponentUpdate(workInProgress, oldProps, newProps, oldState, newState, newContext) {
              ...
              if (typeof instance.shouldComponentUpdate === 'function') {
                ...
                {
                  !(shouldUpdate !== undefined$I) ? warning(false, '%s.shouldComponentUpdate(): Returned undefined instead of a ' + 'boolean value. Make sure to return true or false.', getComponentName(workInProgress) || 'Component') : void 0;
                }
            ...
            function checkClassInstance(workInProgress) {
              ...
              var type = workInProgress.type;
              {
                ...
                !(instance.props === undefined$I || !hasMutatedProps) ? warning(false, '%s(...): When calling super() in `%s`, make sure to pass ' + "up the same props that your component's constructor was passed.", name, name) : void 0;
            ...
            function constructClassInstance(workInProgress, props, renderExpirationTime) {
              ...
              var state = workInProgress.memoizedState = instance.state !== null && instance.state !== undefined$I ? instance.state : null;
            ...
            function mountIndeterminateComponent(current, workInProgress, renderExpirationTime) {
              ...
              if (typeof value === 'object' && value !== null && typeof value.render === 'function' && value.$$typeof === undefined$I) {
                var Component = workInProgress.type;

                // Proceed under the assumption that this is a class instance
                workInProgress.tag = ClassComponent;

                workInProgress.memoizedState = value.state !== null && value.state !== undefined$I ? value.state : null;
            ...
            function updateContextConsumer(current, workInProgress, renderExpirationTime) {
              ...
              if (observedBits === undefined$I || observedBits === null) {
                    ...
                    if (finishedWork.effectTag & Snapshot) {
                      if (current !== null) {
                        ...
                        var snapshot = instance.getSnapshotBeforeUpdate(prevProps, prevState);
                        {
                          ...
                          if (snapshot === undefined$I && !didWarnSet.has(finishedWork.type)) {
            ...
            function scheduleRootUpdate(current, element, expirationTime, callback) {
              ...
              callback = callback === undefined$I ? null : callback;
              if (callback !== null) {
            ...
            implementation) {
              var key = arguments.length > 3 && arguments[3] !== undefined$I ? arguments[3] : null;
            ...
            function createPortal(children, container) {
              var key = arguments.length > 2 && arguments[2] !== undefined$I ? arguments[2] : null;
            ...
            var ReactDOM = {
              ...
              unstable_createPortal: function () {
                ...
                return createPortal.apply(undefined$I, arguments);
              },
